...
export default function URLShortener() {
    return (
        ...
        >
            ...
            <section className="bg-[hsl(260,8%,14%)] py-14 flex flex-col gap-10 items-center text-center text-sm text-[hsl(0,0%,75%)]">
                <div>
                    <svg
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <Link href="/url-shortener">Link Shortening</Link>
                    <Link href="/url-shortener">Branded Links</Link>
                    <Link href="/url-shortener">Analytics</Link>
                </div>
                <div className="flex flex-col gap-3">
                    <Link
                        className="text-white mb-4 font-bold"
                    ...
                    <Link href="/url-shortener">Blog</Link>
                    <Link href="/url-shortener">Developers</Link>
                    <Link href="/url-shortener">Support</Link>
                </div>
                <div className="flex flex-col gap-3">
                    <Link
                        className="text-white mb-4 font-bold"
                    ...
                    <Link href="/url-shortener">About</Link>
                    <Link href="/url-shortener">Our Team</Link>
                    <Link href="/url-shortener">Careers</Link>
                    <Link href="/url-shortener">Contact</Link>
                </div>
